...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.variable_scope("loss"):
    ...
    return (loss, per_example_loss, logits, probabilities,cls_attention)
...
def serving_input_receiver_fn():
  ...
  SentenceBatch={"input_ids":input_ids, "input_mask":input_mask, "segment_ids":segment_ids, "label_ids":label_ids}

  return tf.estimator.export.ServingInputReceiver(SentenceBatch,SentenceBatch )
