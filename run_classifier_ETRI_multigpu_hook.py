...
def main(_):
  ...
  run_config = tf.estimator.RunConfig(train_distribute=distribution, model_dir=FLAGS.output_dir,
                                      save_checkpoints_steps=FLAGS.save_checkpoints_steps, session_config=None, keep_checkpoint_max=3)
  ...
  if FLAGS.do_train and FLAGS.do_eval:
    ...
    hook = tf.contrib.estimator.stop_if_no_increase_hook(estimator, "eval_accuracy", 500, min_steps=1000, run_every_secs=None,run_every_steps=100)
